<div id = "wrapper">
	<img id="logo_men" src="images/menagerie.png" width="300px"/>
		<div id="menu">
			<ul>
				<li id="menegerie">CAFE MENEGERIE</li>
		...
		<img class="hidden" id ="back_3" src="images/image.jpg"/>
		...
		<img class="hidden" id ="back_9" src="images/sek11.jpg"/>
			...
			<div id="left_side">
				<img src="images/jre.png"/></br></br>
					<p>Caffe Menagerie</p>
				<p>Café Menagerie</br>
					Prinz Eugenstrasse 27</br>
					1030 Wien </br>
					t. 01 320 1111 DW 13</br>
					e-mail : menagerie@belvedere-cafe.at</br></br>
					Öffnungszeiten:</br>
					Montag – Sonntag von 10:00 – 18:00
				</p>
			...
			<div id="guestbook">
				...
				<h1>Menagerie</h1>
				<p><b>Comeback der Gaumenfreude<p>
					<p>Mit Geschmacksharmonie auf höchstem Niveau, besten Zutaten aus der Umgebung und größtem handwerklichen Geschick überzeugen sie auch den gehobenen Anspruch. Unser vielfältiges kulinarisches Angebot  reicht von im Butterschmalz gebackenen Kalbsschnitzeln über Lachs-Bagel mit Zitronen-Crème-fraîche bis zu hausgemachten Kuchen und Torten. Eigens für die stilvoll umgestaltete B-Lounge im Unteren Belvedere und das Bistro Menagerie im Oberen Belvedere  kreierten unsere Haubenköche vom Restaurant Hill die Belvedere-Torte, eine Orangen-Mandel-Buttercremetorte mit Marzipan. Und in den Sommermonaten bietet ein breit gefächertes Frühstücksangebot im Freien vor der atemberaubenden Kulisse des barocken Belvedere-Gartens ein Verwöhnprogramm der besonderen Art. </br></br>

Bestellen Sie auch für zu Hause. Natürlich können Sie unsere hausgemachten Torten und Kuchen auch mitnehmen, oder für einen besonderen Anlaß bestellen.</p>
				</div>
				<div class="speisen hidden">
				<h1>Speisen</h1></br>
				<p>Entdecken Sie die Kunstwerke unserer Küche.</p></br>
				<a href="pdf/speisekarte.pdf">Speisekarte.pdf</a>
			</div>
			<div  class="getr hidden">
				<h1>Wein & Getranke</h1>
				<p>Das beste aus der Flasche.</br></br>

					Hier finden Sie unsere Weine & Getränke .</p></br></br>
